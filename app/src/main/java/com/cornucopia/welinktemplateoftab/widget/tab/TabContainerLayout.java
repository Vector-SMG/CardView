...
public class TabContainerLayout extends HorizontalScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.WeLinkUibundleTabContainerLayout, defStyleAttr, 0);
        mDefaultNormalColor = array.getColor(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_default_color,
                ContextCompat.getColor(context, R.color.welink_uibundle_tab_container_layout_normal_color));
        mDefaultSelectedColor = array.getColor(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_selected_color,
                ContextCompat.getColor(context, R.color.welink_uibundle_tab_container_layout_selected_color));
        mIndicatorHeight = array.getDimensionPixelSize(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_indicator_height,
                getResources().getDimensionPixelSize(R.dimen.welink_uibundle_tab_container_layout_indicator_height));
        mHasIndicator = array.getBoolean(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_has_indicator, true);
        mTabTextSize = array.getDimensionPixelSize(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_text_size,
                getResources().getDimensionPixelSize(R.dimen.welink_uibundle_tab_container_layout_text_size));
        mIndicatorTop = array.getBoolean(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_indicator_top, false);
        mIndicatorPaddingLeft = array.getDimensionPixelSize(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_padding_left,
                getResources().getDimensionPixelSize(R.dimen.welink_uibundle_tab_container_layout_indicator_padding_left));
        mIndicatorPaddingRight = array.getDimensionPixelSize(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_padding_right,
                getResources().getDimensionPixelSize(R.dimen.welink_uibundle_tab_container_layout_indicator_padding_right));
        mTabMode = array.getInt(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_mode, MODE_FIXED);
        mTabSpaceOfScrollMode = array.getDimensionPixelSize(R.styleable.WeLinkUibundleTabContainerLayout_welink_uibundle_tcl_tab_space,
                getResources().getDimensionPixelSize(R.dimen.welink_uibundle_tab_container_item_space_of_scrollable));
        array.recycle();
     ...
     *
     * @param indicatorWidthFollowContent
     */
     ...
     */
    public void setmIndicatorPaddingLeftAndRight(int mIndicatorPaddingLeft, int mIndicatorPaddingRight) {
     ...
     */
    public void setupWithViewPager(ViewPager viewPager, boolean useAdapterTitle, boolean autoRefresh) {
        //解除和ViewPager相关的的监听器
        if (mViewPager != null) {
    ...
    protected OnClickListener mTabOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (model != null) {
                selectTab(index, !mHasIndicator, true);
            }
    ...
    private void updateIndicatorPosition(final int index, float offsetPercent) {
        ...
        int preColor = UiUtils.computeColor(getTabSelectedColor(preModel), getTabNormalColor(preModel), offsetPercent);
        int targetColor = UiUtils.computeColor(getTabNormalColor(targetModel), getTabSelectedColor(targetModel), offsetPercent);
    ...
    private void selectTab(final int index, boolean noAnimation, boolean fromTabClick) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                int preColor = UiUtils.computeColor(getTabSelectedColor(prevModel), getTabNormalColor(prevModel), animValue);
                int nowColor = UiUtils.computeColor(getTabNormalColor(nowModel), getTabSelectedColor(nowModel), animValue);
